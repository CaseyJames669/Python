...
win=0
loss=0
wins=[] #SUPPOSE TO CREATE A WINS LIST 
loss=[] #SUPPOSE TO CREATE A LOSS LIST
...
def main():
    ...
    #errors when you try to print len(wins) or len(loss)...
    #so instead printing the list its printing '[]' and '[]'
